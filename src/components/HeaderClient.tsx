...
//               <Link href="/about" className="py-2 text-gray-700 hover:text-blue-600">Help & Contact</Link>
      ...
      <div className="container mx-auto px-4 py-3">
        ...
        <div className="mt-3 md:hidden">
          <form onSubmit={handleSearch} className="flex items-center w-full max-w-2xl border border-gray-300 rounded-full overflow-hidden bg-white">
            ...
            <select className="h-full border-l border-gray-300 px-3 py-2 bg-gray-50 text-sm focus:outline-none focus:bg-white">
              <option value="">All Categories</option>
              <option value="electronics">Electronics</option>
              <option value="fashion">Fashion</option>
              <option value="home">Home</option>
